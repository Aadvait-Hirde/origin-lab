  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 py-5 px-6 lg:px-8">
        <nav className="mx-auto max-w-7xl">
          <div className="flex items-center justify-between">
            ...
            <div
              className={cn(
                'hidden md:flex items-center gap-6 px-4 py-2.5 transition-all duration-300 rounded-full',
                isScrolled
            ...
            <div className="hidden md:block">
               <Button onClick={() => setIsWaitlistOpen(true)}>Apply Now</Button>
            </div>
          </div>
          ...
          {isMobileMenuOpen && (
            <div
              id="mobile-menu"
              className="md:hidden mt-4 rounded-xl bg-white/90 backdrop-blur-md border border-white/50 p-4 shadow-xl"
            >
      ...
      <Dialog open={isWaitlistOpen} onOpenChange={setIsWaitlistOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Applications Due May 25th</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
             <p className="text-sm text-muted-foreground">
                Origin Lab applications for the Summer 2026 cohort are due May 25, 2026 at 11:59 PM EDT.
